...
@include('partials.head')
        ...
        <div
            ...
            <form id="add-form" class="p-6" navigate-form action="{{ route('admin.category.store') }}"
                method="POST">
                @csrf
                ...
                <div class="space-y-4">
                    {{-- Name --}}
                    <div>
                    <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Nama Category <span
