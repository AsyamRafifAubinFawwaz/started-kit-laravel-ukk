<x-layouts.app :title="__('Classrooms')">
                            ...
                            <tr class="hover:bg-blue-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-3">
                                        ...
                                        <button
                                            onclick="openDeleteModal('{{ $classroom->id }}', '{{ $classroom->class_name }}')"
    ...
    <div id="delete-modal"
        ...
        <div class="bg-white rounded-xl p-6 w-full max-w-md">
            <h3 class="text-lg font-bold mb-2">Hapus Classroom</h3>
            <p class="mb-4">
    ...
    <script>
        function openDeleteModal(id, name) {
            ...
            document.getElementById('delete-form').action = '/admin/classrooms/' + id;
