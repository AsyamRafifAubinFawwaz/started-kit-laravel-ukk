<x-layouts.app :title="__('Task Categories')">
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white overflow-hidden shadow-xl rounded-2xl dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
            ...
            <form navigate-form action="{{ route('tasks.update', $data->id) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <!-- Judul Tugas -->
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" id="task_date" name="task_date" value="{{ old('task_date', \Carbon\Carbon::parse($data->task_date)->format('Y-m-d')) }}"
                                class="pl-12 pr-4 py-3.5 block w-full border border-neutral-300 dark:border-neutral-700 rounded-xl text-sm
                                bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white
                                focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Tambahkan deskripsi tugas (opsional)...">{{ old('description', $data->description) }}</textarea>
                        </div>
                        @error('description')
                            <p class="text-xs text-red-600 mt-2 flex items-center gap-1">
                                <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
